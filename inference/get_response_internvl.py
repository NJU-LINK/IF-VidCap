...
class TestModel:
    ...
    def process_video(self, video_path: str, prompt: str):
        ...
        调用处理函数。
        """
        return self.process_video_with_internvl(video_path, self.meta_prompt, prompt)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Specify the InternVL model to use for processing."
    )
    parser.add_argument(
        "-i", "--input_dir",
        type=str,
...
if __name__ == "__main__":
    ...
    '''
    python get_response_internvl.py --model InternVL3_5-4B
    python get_response_internvl.py --model InternVL3_5-8B
    python get_response_internvl.py --model InternVL3_5-38B
    
    # 使用自定义输入输出目录
    python get_response_internvl.py --model InternVL3_5-4B -i ./annotation/test
    '''